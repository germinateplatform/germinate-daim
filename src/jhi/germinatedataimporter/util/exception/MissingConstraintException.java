...
/**
 * {@link MissingConstraintException} extends {@link Exception} and is thrown if a method receives a data type that isn't supported.
 *
 * @author Sebastian Raubach
 */
public class MissingConstraintException extends Exception
{
	private static final long serialVersionUID = 8217661025452314212L;

	private DatabaseColumn column;

	public MissingConstraintException(DatabaseColumn column)
	{
		super();
		this.column = column;
	}

	public MissingConstraintException(String message)
	{
		super(message);
	}

	public MissingConstraintException(Exception e)
	{
		super(e);
	}
